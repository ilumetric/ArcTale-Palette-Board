...
Например, если ассет лежит в папке `Content\ArcProject\Art\Environments\DepotProps\Art`, то имя должно собираться по схеме с названием директории и названием ассета, например: `SM_DepotProps_Art_Paintings_01`.
